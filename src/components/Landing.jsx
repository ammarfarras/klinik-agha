  ...
  return (
    <>
        ...
        <div className="hero-container d-flex justify-content-space-between m-3 mt-0">
          ...
          >
            ...
            <p className="text-white my-4">
              Klinik Pratama dengan Pelayanan Paripurna di pusat Kota Depok,
              Jawa Barat
            </p>
            <Link
              to={"/consult/category"}
      ...
      <section className="service">
        <div className="">
          <h1 className="a-text d-flex mt-5">Tata Nilai AKHLAK</h1>
          <h5 className="text-center mb-5 mx-3">
          Seluruh staf Klinik Pratama berkomitmen untuk memberikan pelayanan <br>
          </br>kesehatan masyarakat dengan prinsip nilai AKHLAK:
          </h5>
        ...
        >
          <div className="a-container ">
            <div className="card-introduction d-flex align-center justify-center">
              ...
              <div className="desc">
                <h2>Visi Klinik Pratama Depok</h2>
                <h5>
                  Menjadi Klinik Pratama dengan Pelayanan Paripurna di Kota
                  Depok Jawa Barat Tahun 2023
                </h5>
                <p>
                  Untuk mencapai visi tersebut, Klinik Pratama Depok
